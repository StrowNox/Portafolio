...
document.addEventListener('DOMContentLoaded', () => {
    ...
    botonAnadirBolsa.addEventListener('click', () => {
        if (tallaSeleccionada) {
            ...
            const nombreProducto = 'SAMBA OG SHOES - Brown-Beige'; // <-- CAMBIA ESTO (ej. 'SAMBA OG SHOES - Brown')
            const imagenProducto = 'https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/f688d77837e144fe8e9fa2b73248a690_9366/Samba_OG_Shoes_White_JH8796_01_standard.jpg'; // <-- CAMBIA ESTO
