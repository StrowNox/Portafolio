...
document.addEventListener('DOMContentLoaded', () => {
    ...
    botonAnadirBolsa.addEventListener('click', () => {
        if (tallaSeleccionada) {
            ...
            const nombreProducto = 'SAMBA OG SHOES - White-Red'; // <-- CAMBIA ESTO (ej. 'SAMBA OG SHOES - Brown')
            const imagenProducto = 'https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/7b283df1eb6c4c9ab4a3afb200f9876a_9366/Samba_OG_Shoes_White_IG1025_01_00_standard.jpg'; // <-- CAMBIA ESTO
