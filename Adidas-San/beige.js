...
document.addEventListener('DOMContentLoaded', () => {
    ...
    botonAnadirBolsa.addEventListener('click', () => {
        if (tallaSeleccionada) {
            ...
            const nombreProducto = 'SAMBA OG SHOES - Beige'; // <-- CAMBIA ESTO (ej. 'SAMBA OG SHOES - Brown')
            const imagenProducto = 'https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/033cd78542cf4b6482557b7434f7eb48_9366/Samba_OG_Shoes_White_JI3204_01_00_standard.jpg'; // <-- CAMBIA ESTO
