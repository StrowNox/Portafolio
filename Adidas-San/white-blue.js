...
document.addEventListener('DOMContentLoaded', () => {
    ...
    botonAnadirBolsa.addEventListener('click', () => {
        if (tallaSeleccionada) {
            ...
            const nombreProducto = 'SAMBA OG SHOES - White-blue'; // <-- CAMBIA ESTO (ej. 'SAMBA OG SHOES - Brown')
            const imagenProducto = 'https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/32f939960439490da70e8fc81e3f5243_9366/Samba_OG_Shoes_Black_IH4882_01_standard.jpg'; // <-- CAMBIA ESTO
